...
print(get_logger(), id(get_logger()))
print(get_logger(), id(get_logger()))
...
class Employee(metaclass=ModelMeta):
    kpi_score = Range(name='kpi_score', min_value=0, max_value=100)


emp = Employee()
print(type(emp), Employee.__mro__, RangeInteger.__mro__)
emp.kpi_score = 15
emp.kpi_score = 500
